			...
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Sosyal Medya</div>
					</div>
					<a href="#" class="btn btn-default"><i class="fa fa-facebook fa-2x"></i>&emsp;     <?php echo $ayarcek['ayar_facebook'] ?></a>

					<a href="#" class="btn btn-default"><i class="fa fa-twitter fa-2x"></i>&emsp;<?php echo $ayarcek['ayar_twitter'] ?></a>

					<a href="#" class="btn btn-default"><i class="fa fa-youtube fa-2x"></i>&emsp;<?php echo $ayarcek['ayar_youtube'] ?></a>

					<a href="#" class="btn btn-default"><i class="fa fa-google fa-2x"></i>&emsp;<?php echo $ayarcek['ayar_google'] ?></a>
				</div><!--footer twitter widget-->
				<div class="col-md-4"><!--footer newsletter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Açıklama</div>
					</div>
